...
import com.scaffold.dynamic.datasource.toolkit.CryptoUtils;
...
@Getter
@Setter
@ConfigurationProperties(prefix = com.scaffold.dynamic.datasource.spring.boot.autoconfigure.DynamicDataSourceProperties.PREFIX)
